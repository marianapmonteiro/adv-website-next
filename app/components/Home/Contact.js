...
const Contact = () => {
    ...
    return (
        <div className="w-full h-auto  bg-white flex flex-col items-center pt-10 text-black pb-14">
            <div className="text-black text-center sm:text-[36px] font-extrabold w-full xs:text-[24px] mb-20">
                <span className="border-b-[4px] h-36 border-yellow rounded-[3px] mt-2">Entre em contato conosco</span>
            </div>
            <div className="md:w-[65%] xl:w-[50%] xs:w-full xs:px-10 md:px-0 justify-self-center">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex md:flex-row xs:flex-col gap-3 w-full mb-[50px] justify-center xs:items-start md:items-center">
                        <label htmlFor="name" className="md:text-[20px] xs:text-[18px]">Nome:</label>
                        <input
                            type="text"
                            id="name"
                            {...register("name")}
                    ...
                    <div className="flex md:flex-row xs:flex-col gap-3 w-full mb-[50px] justify-center xs:items-start md:items-center">
                        <label htmlFor="email" className="md:text-[20px] xs:text-[18px] flex-shrink-0">E-mail:</label>
                        <input
                            type="email"
                            id="email"
                            {...register("email")}
                    ...
                    <div className="flex md:flex-row xs:flex-col gap-3 w-full mb-[50px] justify-center xs:items-start md:items-center">
                        <label htmlFor="topico" className="md:text-[20px] xs:text-[18px]">Tópico:</label>
                        <input
                            type="text"
                            id="topico"
                            {...register("topico")}
                    ...
                    <div className="flex md:flex-row xs:flex-col gap-3 w-full mb-[50px] justify-center xs:items-start">
                        <label htmlFor="message" className="md:text-[20px] xs:text-[18px]">Mensagem:</label>
                        <textarea
                            id="message"
                            {...register("message")}
