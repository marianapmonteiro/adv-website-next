...
const Services = () => {
    ...
    return (
        <div className="w-full h-auto bg-white flex flex-col justify-center xs:pt-16 sm:pt-14 md:pt-10">
            <div className="text-black text-center sm:text-[36px] xs:text-[24px] font-extrabold w-full">
                <h3>Como podemos te ajudar?</h3>
                <div className="w-[70%] bg-yellow h-1 mt-2 mx-auto rounded-2xl"></div>
            </div>
            <div className="md:mt-20 xs:mt-10 h-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 p-4 justify-items-center max-w-[80%] mx-auto ">
                ...
                <div className="w-full flex items-center xs:justify-start sm:justify-end text-black font-extrabold text-[18.66px] gap-4 xs:py-4 md:py-8 col-span-full">
                    <p className="hover:text-yellow transition-colors cursor-pointer">Mais serviços</p>
                    <svg width="167" height="24" className="xs:w-[100px] md:w-[167px]" viewBox="0 0 167 24" fill="none" xmlns="http://www.w3.org/2000/svg">
