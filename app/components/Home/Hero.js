    ...
    return (
        <div className="w-full h-full relative overflow-hidden">
            <div className="relative h-screen w-full">
                ...
                <div className="h-auto max-w-[90%] sm:mt-20 md:w-[40%] lg:w-auto 2xl:w-[28%] border-l-8 border-yellow bg-[#000000CC] sm:px-10 md:pl-10 md:pr-20 xl:px-0 xl:pr-32 xl:pl-14 py-7 2xl:px-0 2xl:pl-12 2xl:pr-0 absolute right-0 top-1/2 -translate-y-1/2 flex flex-col">
                ...
                <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 flex gap-4 sm:w-full sm:flex sm:justify-center sm:items-center">
                    <button onClick={prevStep}>
                        <svg className="sm:w-20 md:w-[167px]" width="167" height="24" viewBox="0 0 167 24" fill="none" xmlns="http://www.w3.org/2000/svg">
